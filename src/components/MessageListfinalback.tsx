        ...
        >
          ...
          <div className="max-w-2xl mx-auto space-y-3">
            <button
              onClick={() =>
                handleNewMessage(
                  "🔍 Análise de Perfil: envie seu perfil para análise."
                )
              }
            ...
            <button
              onClick={() =>
                handleNewMessage(
                  "✍️ Gerador de Bio: descreva seu estilo ou negócio."
                )
              }
              className={`w-full p-4 rounded-xl border ${
                isDarkMode
            ...
            >
              ...
              <div>
                ...
                >
                  Crie biografias personalizadas
                </p>
              </div>
            </button>
            ...
            <button
              onClick={() =>
                handleNewMessage(
                  "🧠 Gerador de Copy: descreva seu produto ou objetivo."
                )
              }
              className={`w-full p-4 rounded-xl border ${
                isDarkMode
